@echo off
REM Optimized RazorFS Performance Testing Script for Windows - Corrected v8 Version
REM Tests O(log n) improvements vs EXT4 vs BTRFS

echo ===============================================
echo RazorFS O(log n) Performance Testing - Corrected v8 Version
echo ===============================================
echo.
...
echo Building corrected v8 optimized test environment...
docker-compose -f docker-compose-optimized-corrected-v8.yml build --no-cache
...
REM Run the tests
docker-compose -f docker-compose-optimized-corrected-v8.yml up --force-recreate
...
docker-compose -f docker-compose-optimized-corrected-v8.yml down
