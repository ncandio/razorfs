@echo off
REM Optimized RazorFS Performance Testing Script for Windows - Corrected v5 Version
REM Tests O(log n) improvements vs EXT4 vs BTRFS

echo ===============================================
echo RazorFS O(log n) Performance Testing - Corrected v5 Version
echo ===============================================
echo.
...
echo Building corrected v5 optimized test environment...
docker-compose -f docker-compose-optimized-corrected-v5.yml build --no-cache
...
REM Run the tests
docker-compose -f docker-compose-optimized-corrected-v5.yml up --force-recreate
...
docker-compose -f docker-compose-optimized-corrected-v5.yml down
