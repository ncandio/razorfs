@echo off
REM Optimized RazorFS Performance Testing Script for Windows - Thorough Debug Version
REM Tests O(log n) improvements vs EXT4 vs BTRFS

echo ===============================================
echo RazorFS O(log n) Performance Testing - Thorough Debug Version
echo ===============================================
echo.
...
echo Building thorough debug optimized test environment...
docker-compose -f docker-compose-optimized-corrected-thorough.yml build --no-cache
...
REM Run the tests
docker-compose -f docker-compose-optimized-corrected-thorough.yml up --force-recreate
...
docker-compose -f docker-compose-optimized-corrected-thorough.yml down
