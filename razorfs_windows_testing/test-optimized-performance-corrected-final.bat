@echo off
REM Optimized RazorFS Performance Testing Script for Windows - Corrected Final Version
REM Tests O(log n) improvements vs EXT4 vs BTRFS

echo ===============================================
echo RazorFS O(log n) Performance Testing - Corrected Final Version
echo ===============================================
echo.
...
echo Building corrected final optimized test environment...
docker-compose -f docker-compose-optimized-corrected-final.yml build --no-cache
...
REM Run the tests
docker-compose -f docker-compose-optimized-corrected-final.yml up --force-recreate
...
docker-compose -f docker-compose-optimized-corrected-final.yml down
