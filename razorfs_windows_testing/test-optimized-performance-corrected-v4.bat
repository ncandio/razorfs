@echo off
REM Optimized RazorFS Performance Testing Script for Windows - Corrected v4 Version
REM Tests O(log n) improvements vs EXT4 vs BTRFS

echo ===============================================
echo RazorFS O(log n) Performance Testing - Corrected v4 Version
echo ===============================================
echo.
...
echo Building corrected v4 optimized test environment...
docker-compose -f docker-compose-optimized-corrected-v4.yml build --no-cache
...
REM Run the tests
docker-compose -f docker-compose-optimized-corrected-v4.yml up --force-recreate
...
docker-compose -f docker-compose-optimized-corrected-v4.yml down
