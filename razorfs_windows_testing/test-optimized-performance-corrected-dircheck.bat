@echo off
REM Optimized RazorFS Performance Testing Script for Windows - Directory Check Version
REM Tests O(log n) improvements vs EXT4 vs BTRFS

echo ===============================================
echo RazorFS O(log n) Performance Testing - Directory Check Version
echo ===============================================
echo.
...
echo Building directory check optimized test environment...
docker-compose -f docker-compose-optimized-corrected-dircheck.yml build --no-cache
...
REM Run the tests
docker-compose -f docker-compose-optimized-corrected-dircheck.yml up --force-recreate
...
docker-compose -f docker-compose-optimized-corrected-dircheck.yml down
