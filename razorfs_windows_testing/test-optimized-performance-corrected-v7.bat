@echo off
REM Optimized RazorFS Performance Testing Script for Windows - Corrected v7 Version
REM Tests O(log n) improvements vs EXT4 vs BTRFS

echo ===============================================
echo RazorFS O(log n) Performance Testing - Corrected v7 Version
echo ===============================================
echo.
...
echo Building corrected v7 optimized test environment...
docker-compose -f docker-compose-optimized-corrected-v7.yml build --no-cache
...
REM Run the tests
docker-compose -f docker-compose-optimized-corrected-v7.yml up --force-recreate
...
docker-compose -f docker-compose-optimized-corrected-v7.yml down
