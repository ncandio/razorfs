@echo off
REM Optimized RazorFS Performance Testing Script for Windows - Direct Compilation Version
REM Tests O(log n) improvements vs EXT4 vs BTRFS

echo ===============================================
echo RazorFS O(log n) Performance Testing - Direct Compilation Version
echo ===============================================
echo.
...
echo Building direct compilation optimized test environment...
docker-compose -f docker-compose-optimized-direct.yml build --no-cache
...
REM Run the tests
docker-compose -f docker-compose-optimized-direct.yml up --force-recreate
...
docker-compose -f docker-compose-optimized-direct.yml down
